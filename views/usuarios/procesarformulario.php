...
$celular           =trim($_POST['celular']);     //$son las variables [''] lo que ingresa el usuario en la interfaz
$correo            =trim($_POST['correo']);      

if (strlen($tipodocumento) >= 1 && strlen($documento) >= 1 &&  strlen($nombre) >= 1 && strlen($celular) >= 1  && strlen ($correo) >= 1   ){ 
