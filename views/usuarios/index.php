...
<div class="container">
  ...
  /////////////////////////////////////
      ...
      <div class="col">
         ...
         <table class="table teble-hover table_sm" >
         <thead>
              <tr>
                  <th scape="col"> # </th>
...
?>
      <tr>
            <th scope="row" ><?= $numero_registro?>  </th>
             <td><?= $usuarios ['nombre'] ?> </td>  <!--abreviacion php   < ? ?> -->
            <td><?= $usuarios ['correo'] ?> </td>
            <td><?= $usuarios ['celular'] ?> </td>
            <td><?= $usuarios ['documento'] ?> </td>
            <td><?= $usuarios ['celular'] ?> </td>
            <td><?= date_format ($date,'d,m,y') ?> </td>    <!--formatear la fecha dando dia me año-->
